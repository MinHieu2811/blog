import { PrismaClient } from './blog-client/index.js'
import { PrismaClient as TrackingPrismaClient } from './tracking-client/index.js'
...
export class Database {
  ...
  static async trackEvent(sessionId, blogId, eventType, eventData) {
  ...
  static async logError(error, event, eventData) {
